...
@interface TrousersViewController ()
...
@implementation TrousersViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        [self.behaviors addObject:[ROFilterBehavior behaviorViewController:self filterControllerClass:[TrousersFilterViewController class]]];
...
- (void)viewDidLoad {
    ...
    self.title = NSLocalizedString(@"Trousers", nil);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ProductsDSItem *item = self.items[(NSUInteger)indexPath.row];
    TrousersDetailViewController *destinationViewController = [TrousersDetailViewController new];
