...
@implementation TiesViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        [self.behaviors addObject:[ROFilterBehavior behaviorViewController:self filterControllerClass:[TiesFilterViewController class]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ProductsDSItem *item = self.items[(NSUInteger)indexPath.row];
    TiesDetailViewController *destinationViewController = [TiesDetailViewController new];
